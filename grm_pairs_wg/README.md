...
```
grm_pairs <bfile> <pair_file> <ms_pair_file> <out_file>
```
...
| `ms_pair_file` | Second IID pair list used to estimate `Ms` |
...
./grm_pairs test_data my_pairs.txt my_pairs.txt output.txt
