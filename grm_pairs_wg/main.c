 ...
 *
 * Usage: grm_pairs <bfile_prefix> <pair_file> <ms_pair_file> <out_file>
 *
 * Expects:
...
{
    if (argc < 5) {
        fprintf(stderr, "usage: grm_pairs <bfile> <pair_file> <ms_pair_file> <out>\n");
        fprintf(stderr,
    ...
    const char* ms_pair_file = argv[3];
    ...
    int ret = calc_rel_pairs(bed_fname, pair_file, ms_pair_file, sample_ids,
