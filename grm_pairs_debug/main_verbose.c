...
/*     header does NOT start with '#'; frequency column is MAF         */
/*     and *alleles_out[k] is set to A1.                               */
/*   .afreq (plink2):  #CHROM ID REF ALT1 ALT1_FREQ OBS_CT            */
/*     header starts with '#'; frequency column is ALT1_FREQ           */
/*     and *alleles_out[k] is set to ALT1.                             */
/*                                                                      */
